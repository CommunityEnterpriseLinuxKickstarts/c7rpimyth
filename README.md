...
Keep in mind just because I made it available for you to respin easily, doesnt mean they UPSTREAM wanted to support that,ever. Last Warning, If you or anyone completely disrepects the system, I might not help you make respins so easily in the future as In NO MORE OPEN BUILD SCRIPT INFO or tips. Then it will be back to the way it was before if you want to build it,  obscure,  then you figure it all out all on your own,  mr. smartie pants!
